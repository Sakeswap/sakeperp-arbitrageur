    ...
    parseConfigFile(): [ PreflightCheck,  Record<string, ExchangeConfig>]{
        ...
        configJson.ExchangeConfig.forEach((value , index) =>{
            ...
            let eConfig: ExchangeConfig = {
                ...
                SAKEPERP_LONG_ENTRY_UPPER_TRIGGER: Big(value.SAKEPERP_LONG_ENTRY_UPPER_TRIGGER), 
                SAKEPERP_LONG_ENTRY_LOWER_TRIGGER: Big(value.SAKEPERP_LONG_ENTRY_LOWER_TRIGGER), 
                ...
                SAKEPERP_SHORT_ENTRY_UPPER_TRIGGER: Big(value.SAKEPERP_SHORT_ENTRY_UPPER_TRIGGER),
                SAKEPERP_SHORT_ENTRY_LOWER_TRIGGER: Big(value.SAKEPERP_SHORT_ENTRY_LOWER_TRIGGER),
...
export interface ExchangeConfig {
    ...
    SAKEPERP_LONG_ENTRY_UPPER_TRIGGER: Big
    SAKEPERP_LONG_ENTRY_LOWER_TRIGGER: Big
    SAKEPERP_LONG_CLOSE_TRIGGER: Big
    SAKEPERP_LONG_OPEN_PRICE_SPREAD: Big
    SAKEPERP_SHORT_ENTRY_UPPER_TRIGGER: Big
    SAKEPERP_SHORT_ENTRY_LOWER_TRIGGER: Big
