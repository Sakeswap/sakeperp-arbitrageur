    ...
    parseConfigFile(): [ PreflightCheck,  Record<string, ExchangeConfig>]{
        ...
        configJson.ExchangeConfig.forEach((value , index) =>{
            ...
            let eConfig: ExchangeConfig = {
                ...
                SAKEPERP_LONG_CEX_OPEN_PRICE_SPREAD: Big(value.SAKEPERP_LONG_CEX_OPEN_PRICE_SPREAD),  
                ...
                SAKEPERP_SHORT_CEX_OPEN_PRICE_SPREAD: Big(value.SAKEPERP_SHORT_CEX_OPEN_PRICE_SPREAD),
